...
const CourseCard: FC<Props> = ({ item, isProfile }) => {
  return (
    ...
    >
      <div className='w-full min-h-[45vh] dark:bg-slate-500 dark:bg-opacity-20 backdrop-blur border dark:border-[#ffffff1d] border-[#00000015] dark:shadow-[bg-slate-700] rounded-lg p-3 shadow-sm dark:shadow-inner'>
        <Image
          src={item?.thumbnail?.url}
          width={500}
          height={300}
          objectFit='contain'
          className='rounded-lg w-[450px] h-[240px] object-cover'
          alt=''
        />
        <br />
